...
from pipeline.sources.gpuhunt_source import classify_interconnect


def test_single_gpu_has_no_interconnect():
    """A single GPU has no inter-GPU link, regardless of card."""
    assert classify_interconnect("H100", "NVIDIA H100 80GB HBM3", 1) is None
    assert classify_interconnect("RTX4090", "NVIDIA GeForce RTX 4090", 1) is None
